            ...
            <Card className='cartCard'>
                ...
                <Card.Body className='card-body'>
                    ...
                    <div className='cart-buttons'>
                        ...
                        <span>
                            <Button variant='primary' disabled={cart.quantity === 1 ? true : false} onClick={() => handleDecreased(cart.id)}>-</Button>
                            <span className='cart-amount'>{cart.quantity}</span>
                            <Button variant='primary' disabled={cart.quantity === cart.stock ? true : false} onClick={() => handleIncrease(cart.id)}>+</Button>
                        </span>
